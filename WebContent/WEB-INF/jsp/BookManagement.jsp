...
<script>
    $(function () {
        $('#table ${"#editbook"}').click(function (e) {
            e.preventDefault();
...
<body onload="myFunction()">
 ...
 %></a> <a class="dropdown-item" href="javascript:void(0)"><i
		...
		<div class="page-wrapper">
            ...
            <tr>
            <td>ISBN: </td><td><input type="text" id="updateisbn" name="updateisbn" size="130dp"/></td>
            </tr>
            <tr>
            <td>Price: </td><td><input type="text" id="updateprice" name="updateprice" size="130dp"/></td>
            </tr>
            <tr>
            <td>Quantity: </td><td><input type="text" id="updatequantity" name="updatequantity" size="130dp"/></td>
            </tr>
            <tr>
